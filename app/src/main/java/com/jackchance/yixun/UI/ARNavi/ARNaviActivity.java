package com.jackchance.yixun.UI.ARNavi;
...
public class ARNaviActivity extends AppCompatActivity implements SensorEventListener {
...
//            float z_displacement = tmp_z - values[2];
    ...
    protected void SetSensor()
    {
        ...
        {
            // 注册Listener & 设定更新速度
            sensorManager.registerListener( ARNaviActivity.this, (Sensor) sensors.get(0), SensorManager.SENSOR_DELAY_GAME);
        }
        else
        {
            Toast.makeText( this, " 您的手机没有传感器! ", Toast.LENGTH_LONG).show();
        }
    }
    ...
    private final class SurfaceViewCallback implements android.view.SurfaceHolder.Callback
    {
        public void surfaceChanged(SurfaceHolder arg0, int arg1, int arg2,
            ...
            try {
                ...
                previewing = true;
                setCameraDisplayOrientation( ARNaviActivity.this,
    ...
    private android.hardware.Camera openFrontFacingCameraGingerbread() {
        ...
        cameraCount = android.hardware.Camera.getNumberOfCameras();// 相机数

        for (int i = 0; i < cameraCount; i++) {

            android.hardware.Camera.getCameraInfo(i, cameraInfo);// 相机讯息CameraInfo
