...
public class FileUtils {
     ...
     * 默认主题
     */
    public static final String DEFAULT_THEME_ID = "bupt-innovation-theme";
    ...
    public static String getMapPath(Context context,String mapid){
        String srcFile = mapid + FILE_TYPE_MAP;
        String destFile = getMapPath(mapid);
        try {
            FileUtils.copyAssetsToSdcard(context, srcFile, destFile);
        } catch (IOException e) {
            e.printStackTrace();
    ...
    public static void copyAssetsThemeToSdcard(Context context) {
        String srcFileName = "bupt-innovation.zip";
